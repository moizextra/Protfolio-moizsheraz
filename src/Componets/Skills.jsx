...
const Skills = () => {
  return (
    <div className='flex flex-col justify-center items-center mt-4' data-aos="fade-up">
       <span className='border px-4 py-1 rounded-full text-center flex items-center justify-center mb-12 skillstag'><SiTalenthouse/> <span className='ml-3'>Skills</span></span>
